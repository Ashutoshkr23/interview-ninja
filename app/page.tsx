...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col bg-black text-white items-center justify-between p-24">
      ...
      <Link className="text-2xl w-40 h-10 rounded-md text-black bg-white hover:bg-gray-400 flex justify-center items-center" href="/interview-options">Start Now</Link> 
    </main>
  );
}
